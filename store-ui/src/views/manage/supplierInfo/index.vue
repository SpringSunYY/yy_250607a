  ...
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="supplierInfoList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="供应商编号" align="center" v-if="columns[0].visible" prop="supplierId" />
        <el-table-column label="供应商名称" :show-overflow-tooltip="true" align="center" v-if="columns[1].visible" prop="supplierName" />
        <el-table-column label="手机号码" :show-overflow-tooltip="true" align="center" v-if="columns[2].visible" prop="phone" />
        <el-table-column label="地址" :show-overflow-tooltip="true" align="center" v-if="columns[3].visible" prop="address" />
