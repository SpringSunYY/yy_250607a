<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="supplierInfoList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="供应商编号" align="center" v-if="columns[0].visible" prop="supplierId"/>
      <el-table-column label="供应商名称" :show-overflow-tooltip="true" align="center" v-if="columns[1].visible"
                       prop="supplierName"
      />
      ...
      <el-table-column label="地址" :show-overflow-tooltip="true" align="center" v-if="columns[3].visible"
                       prop="address"
      />
      <el-table-column label="图片" align="center" v-if="columns[4].visible" prop="supplierImage" width="100">
        <template slot-scope="scope">
          <image-preview :src="scope.row.supplierImage" :width="50" :height="50"/>
        </template>
      </el-table-column>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        ...
        <el-form-item label="图片" prop="supplierImage">
          <image-upload v-model="form.supplierImage"/>
        </el-form-item>
...
export default {
  ...
  data() {
    return {
      //表格展示列
      columns: [
        { key: 0, label: '供应商编号', visible: false },
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除供货商信息编号为"' + supplierIds + '"的数据项？').then(function() {
