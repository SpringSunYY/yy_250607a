  ...
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="goodsPurchaseInfoList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="进货编号" align="center" v-if="columns[0].visible" prop="purchaseId" />
        ...
        <el-table-column label="供应商" :show-overflow-tooltip="true" align="center" v-if="columns[3].visible" prop="supplierId" />
        <el-table-column label="进货标题" :show-overflow-tooltip="true" align="center" v-if="columns[4].visible" prop="purchaseTitle" />
        <el-table-column label="进货价格" :show-overflow-tooltip="true" align="center" v-if="columns[5].visible" prop="purchasePrice" />
        <el-table-column label="进货数量" :show-overflow-tooltip="true" align="center" v-if="columns[6].visible" prop="quantity" />
