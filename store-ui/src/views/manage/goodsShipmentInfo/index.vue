...
<!--      </el-col>-->
    ...
    <el-table v-loading="loading" :data="goodsShipmentInfoList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="商品编号" :show-overflow-tooltip="true" align="center" v-if="columns[2].visible"
                       prop="goodsName"
      />
      <el-table-column label="出货标题" :show-overflow-tooltip="true" align="center" v-if="columns[3].visible"
                       prop="shipmentTitle"
      />
      <el-table-column label="出货数量" :show-overflow-tooltip="true" align="center" v-if="columns[4].visible"
                       prop="quantity"
      />
      <el-table-column label="出货价格" :show-overflow-tooltip="true" align="center" v-if="columns[5].visible"
                       prop="shipmentPrice"
      />
...
<script>
import {
  listGoodsShipmentInfo,
  getGoodsShipmentInfo,
  delGoodsShipmentInfo,
  addGoodsShipmentInfo,
  updateGoodsShipmentInfo
} from '@/api/manage/goodsShipmentInfo'
...
export default {
  ...
  data() {
    return {
      //表格展示列
      columns: [
        { key: 0, label: '出货编号', visible: false },
